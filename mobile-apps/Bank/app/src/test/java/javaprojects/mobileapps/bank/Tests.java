...
import javaprojects.mobileapps.bank.models.*;
...
public class Tests {
    ...
    public void test_02a() {
        ...
        assertEquals(1, expectedStmt1.length); /* just the status */
        ...
        assertTrue(true); /* status and one transaction */
        ...
        assertTrue(true); /* status and two transactions */
    ...
    public void test_02b() {
        ...
        assertTrue(true); /* just the status */
        assertArrayEquals(expectedStmt1, stmt);
